...
const Contact = () => {
  ...
  return (
    <div className="container px-4 py-8 sm:py-12 mx-auto max-w-7xl">
      <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-center mb-6 sm:mb-8">
        Liên Hệ Với Chúng Tôi
      </h1>
      
      <div className="grid gap-6 sm:gap-10 md:grid-cols-2 lg:gap-16">
        {/* Contact Information */}
        <div className="space-y-6 sm:space-y-8">
          <div className="bg-card rounded-lg p-4 sm:p-6 shadow-sm">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">Thông Tin Liên Hệ</h2>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm sm:text-base">{storeInfo.address}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm sm:text-base">{storeInfo.phone}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm sm:text-base">{storeInfo.email}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm sm:text-base">{storeInfo.workingHours}</p>
          ...
          {/* Zalo Contact */}
          <div className="bg-card rounded-lg p-4 sm:p-6 shadow-sm">
            <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Kết Nối Zalo</h3>
            ...
            <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
              ...
              <div>
                <p className="font-medium text-sm sm:text-base">{zaloInfo.displayName}</p>
                <p className="text-xs sm:text-sm text-muted-foreground">{zaloInfo.phoneNumber}</p>
              </div>
              <Button 
                className="ml-auto gap-1 sm:gap-2" 
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center">
              <div className="bg-white p-2 rounded-md w-28 h-28 sm:w-32 sm:h-32 border">
                <img 
                  src="/placeholder.svg" 
                  alt="Zalo QR Code" 
              ...
              <div>
                <p className="font-medium text-sm sm:text-base">Quét mã QR để kết nối</p>
          ...
          {/* Social Media */}
          <div className="bg-card rounded-lg p-4 sm:p-6 shadow-sm">
            <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Kết Nối Mạng Xã Hội</h3>
            <div className="flex gap-3 sm:gap-4">
              <Button variant="outline" size={isMobile ? "sm" : "icon"} asChild>
                <a href={storeInfo.social.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                  <svg xmlns="http://www.w3.org/2000/svg" width={isMobile ? "18" : "24"} height={isMobile ? "18" : "24"} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
                </a>
              </Button>
              <Button variant="outline" size={isMobile ? "sm" : "icon"} asChild>
                <a href={storeInfo.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  <svg xmlns="http://www.w3.org/2000/svg" width={isMobile ? "18" : "24"} height={isMobile ? "18" : "24"} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-instagram"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                </a>
              </Button>
              <Button variant="outline" size={isMobile ? "sm" : "icon"} asChild>
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          {/* Location Map */}
          <div className="bg-card rounded-lg p-4 sm:p-6 shadow-sm">
            <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Vị Trí Cửa Hàng</h3>
            <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">
              Dễ dàng tìm thấy chúng tôi tại địa chỉ bên dưới:
            </p>
            <div className="h-[250px] sm:h-[300px] mb-3 sm:mb-4 overflow-hidden rounded-md">
              <StoreLocation />
            </div>
